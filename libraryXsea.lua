...
local XSeaLib = {}
function XSeaLib:Notify(NotifyConfig)
...
function XSeaLib:Start(GuiConfig)
    local GuiConfig = GuiConfig or {}
    GuiConfig.Name = GuiConfig.Name or "X-Sea Hub"
	...
	GuiConfig["Name Info"] = GuiConfig["Name Info"] or "XSea Info"
    GuiConfig["Name Player"] = GuiConfig["Name Player"] or tostring(game:GetService("Players").LocalPlayer.Name)
    GuiConfig["Info Description"] = GuiConfig["Info Description"] or "New"
    ...
    --// Gui
    local XseaGui = Instance.new("ScreenGui");
    ...
    XseaGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    XseaGui.Name = "XseaGui"
    XseaGui.Parent = CoreGui
    ...
    Main.Name = "Main"
    Main.Parent = XseaGui
    Main.Position = UDim2.new(0, (XseaGui.AbsoluteSize.X // 2 - Main.Size.X.Offset // 2), 0, (XseaGui.AbsoluteSize.Y // 2 - Main.Size.Y.Offset // 2))
    ...
    function XSeaLib:ToggleUI()
        Main.Visible = not Main.Visible
    end
    function XSeaLib:CloseUI()
        XseaGui:Destroy()
    end
